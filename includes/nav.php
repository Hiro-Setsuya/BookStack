    ...
    <div class="container-fluid">
        ...
        <div class="ms-auto d-flex align-items-center">
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <a href="profile.php" class="btn btn-green d-lg-none d-flex align-items-center justify-content-center px-3">
                    <i class="bi bi-person-circle"></i>
                    <span class="d-none d-sm-inline ms-2"><?php echo htmlspecialchars($_SESSION['user_name'] ?? 'User'); ?></span>
                </a>
            <?php else: ?>
                <a href="login.php" class="btn btn-green d-lg-none d-flex align-items-center justify-content-center fw-normal px-3">
