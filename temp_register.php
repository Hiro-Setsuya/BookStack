...
<head>
    ...
    <style>
        ...
        .hero-bg {
            position: absolute;
            inset: 0;
            background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuCIoK5ON3fNix4R5UudmJLkfVPp-UUPwySrnYrSe-NCBFLxeprqwdYAlhE26KlJ7QfsqEsTkq-KvTat5c5-TuhtokpLsd2PuDlEJVPhcNPA4ULA7ZJ6KaAUVi6uD-t2DxvUBN77Xpc3u5j24_hy6kOPcoWwINws_qtozjKIJVjCAddZwVrlWZpx8KwZvkKfJV77Xxpst_Oy890jgElN-EkilpZIlDXF-QaYJ61J6vg3yMnSaI03ngRMui9tvtzlmcLrBC-qlLhmysE');
        ...
        .hero-overlay {
            position: absolute;
            inset: 0;
            background: linear-gradient(to top right, rgba(13, 89, 242, 0.9), rgba(13, 89, 242, 0.4));
...
<body>
    <div class="container-fluid min-vh-100">
        <div class="row min-vh-100">
            ...
            <div class="col-lg-6 d-none d-lg-flex hero-section align-items-center justify-content-center">
                <div class="hero-bg"></div>
                <div class="hero-overlay"></div>
                <!-- Hero Content -->
                <div class="hero-content px-5" style="max-width: 600px;">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        <div class="icon-box rounded-3 d-flex align-items-center justify-content-center">
                            <svg class="text-white" width="24" height="24" fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                                <path d="M24 4C25.7818 14.2173 33.7827 22.2182 44 24C33.7827 25.7818 25.7818 33.7827 24 44C22.2182 33.7827 14.2173 25.7818 4 24C14.2173 22.2182 22.2182 14.2173 24 4Z" fill="currentColor"></path>
                            </svg>
                        </div>
                        <h2 class="fs-2 fw-bold mb-0">EduBooks</h2>
                    </div>
                    <h1 class="display-4 fw-bold mb-4">Expand your mind, <br />one page at a time.</h1>
                    <p class="fs-5 mb-5 opacity-75">Join over 2 million students worldwide accessing the largest digital library for academic resources.</p>
                    <!-- Social Proof / Stats -->
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="stat-card p-4 rounded-3 shadow-lg">
                                <div class="d-flex align-items-center gap-2 mb-2 opacity-75">
                                    ...
                                    <span class="small fw-bold text-uppercase">Resources</span>
                                </div>
                                <div class="display-5 fw-bold">1.2M+</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="stat-card p-4 rounded-3 shadow-lg">
                                <div class="d-flex align-items-center gap-2 mb-2 opacity-75">
                                    ...
                                    <span class="small fw-bold text-uppercase">Students</span>
                                </div>
            ...
            <div class="col-12 col-lg-6 d-flex flex-column align-items-center justify-content-center p-4 p-lg-5">
                <div class="w-100" style="max-width: 520px;">
                    ...
                    <div class="d-flex d-lg-none align-items-center gap-2 mb-4 justify-content-center">
                        <div class="icon-box rounded-3 d-flex align-items-center justify-content-center bg-primary bg-opacity-10">
                            <svg class="text-primary" width="20" height="20" fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                                <path d="M24 4C25.7818 14.2173 33.7827 22.2182 44 24C33.7827 25.7818 25.7818 33.7827 24 44C22.2182 33.7827 14.2173 25.7818 4 24C14.2173 22.2182 22.2182 14.2173 24 4Z" fill="currentColor"></path>
                            </svg>
                        </div>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-check mb-4">
                            ...
                            <label class="form-check-label small text-muted ms-2" for="terms">
                                By creating an account, you agree to our <a href="#" class="fw-bold text-primary text-decoration-none">Terms of Service</a> and <a href="#" class="fw-bold text-primary text-decoration-none">Privacy Policy</a>.
                            </label>
                        </div>
                        <!-- Submit Button -->
                        <button type="submit" class="btn btn-primary w-100 py-3 fw-bold fs-6 shadow">
                            Create Account
                        </button>
                    </form>
                    <!-- Footer Link -->
                    <div class="text-center mt-4">
                        <p class="text-muted">
                            ...
                            <a href="login.php" class="fw-bold text-primary text-decoration-none">Log in</a>
                        </p>
                    </div>
                </div>
            </div>
