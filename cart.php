...
<body>
  <!-- navbar -->
  <nav class="navbar navbar-expand-lg shadow-sm fixed-top px-4 py-3 bg-light">
    <div class="container-fluid">
      ...
      <div class="ms-auto d-flex align-items-center gap-2">
        <?php if (isset($_SESSION['user_id'])): ?>
          <a href="profile.php" class="btn btn-sm btn-green d-lg-none">
            <i class="bi bi-person-circle"></i>
          </a>
        <?php else: ?>
          <a href="login.php" class="btn btn-sm btn-green d-lg-none">Sign In</a>
        <?php endif; ?>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-lg-4 gap-1">
          ...
          <li class="nav-item">
            <a class="nav-link px-3 py-2" href="ebooks.php">
              <i class="bi bi-book me-2"></i>E-Books
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link px-3 py-2" href="ebook-details.php">
              <i class="bi bi-grid me-2"></i>Categories
            </a>
          </li>
          <li class="nav-item d-lg-none">
            <a class="nav-link px-3 py-2 active" aria-current="page" href="cart.php">
      ...
      <div class="ms-auto d-none d-lg-flex align-items-center gap-3">
        <div class="position-relative">
          ...
          <input class="form-control form-control-sm ps-4 py-2 border-0" type="text" placeholder="Search books..." style="width: 200px; background-color: rgba(46, 204, 113, 0.08); border-radius: 20px; font-size: 0.875rem;">
        </div>
        <a href="cart.php" class="btn btn-sm btn-green d-flex align-items-center justify-content-center position-relative" style="width: 36px; height: 36px; border-radius: 50%; padding: 0;">
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
          <div class="dropdown">
            <button class="btn btn-sm btn-green d-flex align-items-center gap-2 px-3 py-2" type="button" id="userDropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" style="border-radius: 20px;">
              <i class="bi bi-person-circle"></i>
              <span class="small"><?php echo htmlspecialchars($_SESSION['user_name']); ?></span>
            </button>
            <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2" aria-labelledby="userDropdown" style="border-radius: 12px; min-width: 180px;">
              <li><a class="dropdown-item py-2 px-3" href="profile.php"><i class="bi bi-person me-2"></i>Profile</a></li>
              <li><a class="dropdown-item py-2 px-3" href="orders.php"><i class="bi bi-bag me-2"></i>Orders</a></li>
              <li>
                <hr class="dropdown-divider my-1">
              </li>
              <li><a class="dropdown-item py-2 px-3 text-danger" href="logout.php"><i class="bi bi-box-arrow-right me-2"></i>Logout</a></li>
            </ul>
          </div>
        <?php else: ?>
          <a href="login.php" class="btn btn-sm btn-green px-4 py-2" style="border-radius: 20px;">Sign In</a>
        <?php endif; ?>
      </div>
    </div>
  </nav>
