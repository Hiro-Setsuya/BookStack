    ...
    <div class="row">
      ...
      <div class="col-lg-8 mb-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <div class="h2 fw-bold">Your Cart</div>
          <div class="fs-6">2 Items</div>
        </div>

        <div class="card p-3 mb-3">
          <div class="row">
            <div class="col-3">
              <img src="https://m.media-amazon.com/images/I/519LoIgUAFL.jpg" height="120">
            </div>
            <div class="col-6">
              <div class="fs-4 fw-bold">Sample Book 1</div>
              <div class="mb-4">Sample Author 1</div>
              <div class="btn btn-sm btn-danger me-2">
                <i class="bi bi-trash-fill"></i>
                <span class="d-none d-md-inline ms-2">Remove</span>
              </div>
              <div class="btn btn-sm btn-green">
                <i class="bi bi-heart-fill"></i>
                <span class="d-none d-md-inline ms-2">Save for Later</span>
              </div>
            </div>
            <div class="col-3">
              <div class="fs-5 fw-semibold">₱100.00</div>
            </div>
          </div>
        </div>
        ...
        <div class="card p-3 mb-2">
          <div class="row">
            <div class="col-3">
              <img src="https://imgv2-2-f.scribdassets.com/img/word_document/317276308/original/adfe3e30f6/1585165423?v=1" height="120">
            </div>
            <div class="col-6">
              <div class="fs-4 fw-bold">Sample Book 2</div>
              <div class="mb-4">Sample Author 2</div>
              <div class="btn btn-sm btn-danger me-2">
                <i class="bi bi-trash-fill"></i>
                <span class="d-none d-md-inline ms-2">Remove</span>
              </div>
      ...
      <div class="col-lg-4 mb-3 sticky-summary">
        <div class="card p-3 position-sticky" style="top: 90px;">
          ...
          <div class="d-flex mb-5">
            ...
            <button class="btn btn-sm btn-green">Apply</button>
          </div>
          <a class="btn btn-green" href="checkout.php">Proceed to Checkout</a>
        </div>
      </div>
